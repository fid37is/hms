...
export const createWorkOrderSchema = Joi.object({
  ...
  asset_id:    Joi.string().uuid().optional().allow(null, ''),
  description: Joi.string().trim().optional().allow('', null),
  location:    Joi.string().trim().optional().allow('', null),
  room_id:     Joi.string().uuid().optional().allow(null, ''),
  category:    Joi.string().valid('general','electrical','plumbing','hvac','furniture','appliance','structural','other').optional().allow(null),
