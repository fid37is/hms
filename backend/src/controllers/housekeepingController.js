...
export const getAllTasks = async (req, res, next) => {
  try {
    ...
    const { data, total } = await housekeepingService.getAllTasks(
      req.orgId, { status, room_id, assigned_to, task_type, priority },
...
export const getTaskById = async (req, res, next) => {
  try {
    const data = await housekeepingService.getTaskById(req.orgId, req.params.id);
...
export const updateTask = async (req, res, next) => {
  try {
    const data = await housekeepingService.updateTask(req.orgId, req.params.id, req.body);
...
export const startTask = async (req, res, next) => {
  try {
    const data = await housekeepingService.startTask(req.orgId, req.params.id, req.user.sub);
...
export const completeTask = async (req, res, next) => {
  try {
    const data = await housekeepingService.completeTask(req.orgId, req.params.id, req.user.sub, req.body.notes);
...
export const inspectTask = async (req, res, next) => {
  try {
    const data = await housekeepingService.inspectTask(req.orgId, req.params.id, req.user.sub, req.body.notes);
...
export const deleteTask = async (req, res, next) => {
  try {
    const data = await housekeepingService.deleteTask(req.orgId, req.params.id);
...
export const getPendingByRoom = async (req, res, next) => {
  try {
    const data = await housekeepingService.getPendingByRoom(req.orgId, req.params.roomId);
...
export const getAllLostAndFound = async (req, res, next) => {
  try {
    ...
    const { data, total } = await housekeepingService.getAllLostAndFound(
      req.orgId, { status }, Number(page), Number(limit)
    );
...
export const getLostAndFoundById = async (req, res, next) => {
  try {
    const data = await housekeepingService.getLostAndFoundById(req.orgId, req.params.id);
...
export const createLostAndFoundItem = async (req, res, next) => {
  try {
    const data = await housekeepingService.createLostAndFoundItem(req.orgId, req.body, req.user.sub);
...
export const updateLostAndFoundItem = async (req, res, next) => {
  try {
    const data = await housekeepingService.updateLostAndFoundItem(req.orgId, req.params.id, req.body);
...
export const markReturned = async (req, res, next) => {
  try {
    const data = await housekeepingService.markReturned(req.orgId, req.params.id, req.body.guest_id, req.body.notes);
