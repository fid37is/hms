...
export const registerOrg = async ({ org_name, admin_email, admin_password, admin_name }) => {
  ...
  const defaultLayout = {
    nav_style: 'transparent_scroll', hero_style: 'fullscreen', card_style: 'portrait',
  ...
  const defaultContent = {
    ...
    amenities: { eyebrow: 'What We Offer', headline: 'Featured Amenities', items: [] },
    why_stay:  { eyebrow: 'The Experience', headline: 'Life at the Hotel', tiles: [], pillars: [] },
    story:     { eyebrow: 'Our Story', headline: 'Designed for those', headlineSub: 'who expect more', body: '', ctaLabel: 'Explore the Hotel', links: [] },
    offers:    { eyebrow: 'Special Offers', headline: 'Packages & Rates', ctaLabel: 'All Offers', bookLabel: 'Book This Offer', items: [] },
    events:    { eyebrow: 'Events & Venues', headline: 'Host your next', headlineSub: 'unforgettable event.', body: '', ctaLabel: 'Explore Venues & Enquire', venues: [] },
