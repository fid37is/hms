...
import { Bell, Sun, Moon, LogOut, ChevronDown, Menu } from 'lucide-react';
      ...
      <div className="flex items-center gap-2">
          ...
          >
            ...
            {unreadCount > 0 && (
              <span className="absolute top-1 right-1 flex items-center justify-center rounded-full text-white font-bold"
                style={{ backgroundColor: 'var(--s-red-text)', fontSize: 9, minWidth: 14, height: 14, padding: '0 3px', lineHeight: 1 }}>
        ...
        <div className="relative ml-1" ref={menuRef}>
          <button
            ...
            onMouseLeave={e => e.currentTarget.style.backgroundColor = 'transparent'}
          >
            <div className="w-7 h-7 rounded-full overflow-hidden flex items-center justify-center text-xs font-bold uppercase flex-shrink-0"
