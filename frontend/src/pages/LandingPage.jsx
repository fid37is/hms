...
/* ─── Pricing ───────────────────────────────────────────────── */
const PRICES = {
  NGN: { symbol: '₦', monthly: 60000, annual: 600000, locale: 'en-NG' },
            ...
            {[
              {
                n: '01',
                t: 'Visibility',
                em: 'See your entire operation clearly',
                d: 'A real-time view of every room, booking, staff member, and revenue stream. No blind spots, no surprises.'
              },
              {
                n: '02',
                t: 'Control',
                em: 'One platform, zero chaos',
                d: 'Every department - front desk, housekeeping, maintenance, billing - connected in one seamless system. Manage multiple properties from a single account.'
              },
              {
                n: '03',
                t: 'Growth',
                em: 'Built to scale with you',
                d: 'From your first room to your hundredth, from one property to a group - Cierlo grows alongside your business.'
              },
            ].map((p, i) => (
