...
const EMPTY = { name: '', description: '', base_rate: '', max_occupancy: 2 };
    ...
    <div className="space-y-4">
      ...
      {showForm ? (
        <form
          onSubmit={e => {
            e.preventDefault();
            create.mutate({ ...form, base_rate: Number(form.base_rate) * 100, max_occupancy: Number(form.max_occupancy) });
          }}
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="form-group">
              ...
              <input className="input" type="number" required value={form.base_rate}
                onChange={e => setForm({ ...form, base_rate: e.target.value })} />
            </div>
            <div className="form-group">
              <label className="label">Max Occupancy</label>
              <input className="input" type="number" value={form.max_occupancy}
